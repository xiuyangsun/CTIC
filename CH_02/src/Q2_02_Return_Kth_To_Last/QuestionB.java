...
//	Two pointer
//	First Pointer get to the kth node
//	second pointer start
//	when first pointer reaches the end of the list second point reaches the kth node to the end of the end
